...
return [
    ...
    */
    ...
    'options' => [
        ...
        'repository' => 'git@gitlab.waaup.cn:root/wes.git',
        'shared_dirs' => ['public/uploads', 'public/storage', 'public/thumbnail'],
    ],
    ...
    */
    ...
    'hosts' => [
        '192.168.0.206' => [
            'stage' => 'test',
            'deploy_path' => '/var/www/html/wes',
            'user' => 'root',
            'configFile'   => '/var/.ssh/config',

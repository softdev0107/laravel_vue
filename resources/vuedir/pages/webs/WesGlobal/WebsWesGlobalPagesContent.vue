...
<script>
    ...
    export default {
        ...
        components: {
            'WebsWesGlobalPagesContentList': () => import('../../../pages/webs/WesGlobal/WebsWesGlobalPagesContentList'),
            'WebsWesGlobalPagesContentType': () => import('../../../pages/webs/WesGlobal/WebsWesGlobalPagesContentType'),
            'WebsWesGlobalPagesContentSidebar': () => import('../../../pages/webs/WesGlobal/WebsWesGlobalPagesContentSidebar'),
        },
        data(){
            return {

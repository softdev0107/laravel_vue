...
class CreateWebweschinaAppeaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        if (Schema::hasTable('webweschina_appea')==false) {
            Schema::create('webweschina_appea', function (Blueprint $table) {
                $table->id();
    ...
    {
        Schema::dropIfExists('webweschina_appea');
    }
}
